    ...
    <div className="w-full relative flex flex-col justify-start items-center gap-2 *:select-none">
      <div className="w-full relative flex flex-row justify-between items-center">
        ...
        {href && (
          <Link
            href={href}
            className="h-8 px-3 text-textColor/80 hover:text-primeryColor border border-textColor/80 hover:border-primeryColor hover:bg-textColor/10 rounded-full text-sm font-normal capitalize flex justify-center items-center"
          >
            see all
          </Link>
        )}
